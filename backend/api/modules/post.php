...
class Post extends GlobalMethods
{
    ...
    public function addUser($data)
    {
        ...
        $sql = "INSERT INTO user(first_name, last_name, year_level, block, course, email, password) VALUES(:first_name, :last_name, :year_level, :block, :course, :email, :password)";
        ...
        try {
            ...
            return $this->sendPayload(null, 'fauled', $e->getMessage(), 500);
        }
    }
    ...
    public function editUser($data, $user_id)
    {
        ...
        $sql = "UPDATE user SET first_name = ?, last_name = ?, year_level = ?, course = ?, block = ?, email = ? WHERE user_id = ? ";
